...
under flip/logic.  It is intended that no more tests or logic modules
be added to those directories, and that organization is not
recommended for new logic packages and their tests.)
...
To do regression testing using the plogdiff or the poset_all_test
commands (in the FLiP/bin directory, described in FLiP/notes/test.txt)
you must execute the commands from this directory, and the parent
directory .. must be on the PYTHONPATH.
