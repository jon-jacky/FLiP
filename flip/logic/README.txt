...
contains the natural deduction proof checker module, nd.py.  Tests for
all the logics defined here are in the flip/test directory (flip.test
package).

To start an interactive proof session for a particular logic from
within the logic directory, invoke its session module:
 python fol_session.py
...
interactive proof session anywhere this way:
  python -m flip.logic.fol_session
